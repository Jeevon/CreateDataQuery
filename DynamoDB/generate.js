...
module.exports = function(dir, app, arn, tables) {
    ...
    for (let a = 0; a < tables.length; a++) {
        ...
        fs.outputFile(__dirname + '/../../centralizedlogger/lambda/cloudwatch-metrics/queries/DynamoDB/' + dir + '/' + tables[a] + '.js', 'module.exports = ' + JSON.stringify(output), function(err) {
            if (err) {
                console.log(err);
            }
        });
